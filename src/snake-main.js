...
function render() {
  ...
  autoPlayButton.textContent = autoPlayEnabled ? "自动巡航：开" : "自动巡航：关";
  autoStatusElement.textContent = autoPlayEnabled ? "AI 巡航开启" : "手动模式";
  if (strategyElement) {
    strategyElement.textContent = autoPlayEnabled
      ? "策略：优先走安全路、追食物，同时尽量避免形成短循环和死胡同。"
      : "手动时可以借助边界拉开蛇身，给自己留回旋空间。";
  }
